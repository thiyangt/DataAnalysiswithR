...
subtitle:  <span style="color:#8dcefc">Online Workshop - Section C - SLAAS </span>
author: <span style="color:#8dcefc">Priyanga Dilini Talagala </span>
#institute: "RStudio, PBC"
date: <span style="color:#8dcefc">29/08/2021</span> </br></br>`r knitr::include_graphics("fig/ggplot2.png")` `r knitr::include_graphics("fig/15_palmerpenguins2.png")`
output:
...
```{r   out.width = "10%", echo = FALSE, fig.cap=''}
