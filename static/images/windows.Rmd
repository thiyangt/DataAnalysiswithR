...
Without	installing R,	you	will	not	be	able	to	install RStudio and additional packages	later. If you want to watch a step-by-step tutorial on how to install R for Windows, you can watch the video here: https://www.youtube.com/watch?v=Ohnk9hcxf9M
